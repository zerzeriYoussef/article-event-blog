...
class EventParticipationRejected extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('Your participation request has been declined'))
            ->line(__('Unfortunately, your request to join the event ":event" has been declined.', ['event' => $postName]))
            ->action(__('View Event'), route('posts.show', $postSlug))
            ->line(__('You can try requesting again or explore other events.'));
    }
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => __('Your request to join the event ":event" has been declined.', ['event' => $postName]),
